...
const Details = () => {
    ...
    return (
      <>
        ...
        <section>
          <div><h1>Online Research Guides</h1>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad excepturi, suscipit nisi possimus officia expedita numquam explicabo? Recusandae dicta, hic quaerat excepturi reiciendis fugit fugiat deserunt, odio officiis maiores neque.</p>
          </div>
          ...
          <div className='container shadow flexSB'>
            ...
            <div className='right row'>
              ...
              <div className='items grid2'>
                <div className='box'>
                  <h4>ADDRESS:</h4>
                  <p>kn 12 Street, Kigali, Rwanda</p>
                </div>
                <div className='box'>
                  <h4>EMAIL:</h4>
                  <p> menyaedu@gmail.com</p>
                </div>
                <div className='box'>
                  <h4>PHONE:</h4>
                  <p> +250-783-262-792</p>
